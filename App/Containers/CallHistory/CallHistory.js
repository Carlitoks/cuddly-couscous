...
import { CallHistoryComponent } from "../../Components/CallHistory/CallHistoryComponent";
      ...
      <View style={{ flex: 1 }}>
        ...
        {this.state.selectedIndex === 0 && (
          <View style={styles.container}>
            ...
            <CallHistoryComponent data={this.state.AllCalls} />
          </View>
        )}
        {this.state.selectedIndex === 1 && (
          <View style={styles.container}>
            <Text style={styles.title}>{"Missed"}</Text>
            <CallHistoryComponent data={this.state.Missed} />
          </View>
        )}
