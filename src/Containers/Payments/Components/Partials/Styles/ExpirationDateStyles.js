...
export default StyleSheet.create({
  EDContainer: {flexDirection: 'column', width:'60%'},
  ...
  EDInputActive: {color: "#000", borderBottomWidth: 2, borderBottomColor: '#3F1674', width: metrics.width * 0.35, padding: 1},  
  CCIconContainer: {right: -5, top: -5},
