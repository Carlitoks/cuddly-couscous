  ...
  render() {
    ...
    return (
      <View style={styles.minutesLeftContainer}>
        { stripePaymentToken ? <React.Fragment /> : <TouchableOpacity onPress={() => this.goToPayments()} style={styles.addCardContainer}>
        ...
        <View style={styles.minutesLeftInfoContainer}>
          ...
          <Text style={styles.minutesLeftInfoText}>{I18n.t("minutesAbbreviation", { minutes: availableMinutes })}</Text>
        </View>
      </View>
    );
  }
