...
export default StyleSheet.create({
  ...
  flexEndCenter: { justifyContent: "center", alignItems: "center", flexGrow: 1 },
  baseText: {
  ...
  bottomDividerContainer: {marginTop: metrics.height * 0.03, justifyContent: 'center', alignItems: 'flex-start', marginLeft: 20},
  divider: { backgroundColor: '#979797', width: metrics.width * 0.90, height: 1 },
  addComments: { paddingBottom: 19, paddingTop: 19, fontFamily: Fonts.BaseFont, fontSize: 24, color: '#401674' },
});
