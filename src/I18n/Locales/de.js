export default (DE = {
  acceptAllPermissionsCustomer: "Sie müssen Mikrofon- und Kameraberechtigungen in Ihren Einstellungen aktivieren, um mit Jeenie telefonieren zu können.",
  acceptAllPermissionsLinguist: "Sie müssen Mikrofon- und Kameraberechtigungen in Ihren Einstellungen akzeptieren, bevor Sie einen eingehenden Anruf annehmen können.",
  ...
  history: {
    all: "Alle",
    missed: "Verpasst",
    none: "Kein Verlauf verfügbar",
    listTitle: "Anrufverlauf",
    callTitle: "Anrufdetails",
    languages: "Sprachen",
    duration: "Dauer",
    durationTime: "{{num}} Minuten",
    scenario: "Szenario",
  ...
  session: {
    ...
    rating: {
      ...
      about: {
        label: "Anrufdetails",
        placeholder: "Geben Sie den Inhalt des Anrufs in zwei Sätzen wieder. Beispiel: Thema des Anrufs war der Kauf eines Zugtickets von Tokio nach Osaka. Der Kunde benötigte Hilfe bei Bedienung des Ticketautomaten."
      },
      classification: "Anruftyp",
      classifications: {
      ...
      technical: {
        label: "Technische Probleme (optional)",
        placeholder: "Beschreiben Sie, falls relevant, ausführlich die technischen Probleme während des Anrufs."
      },
      technicalFlags: {
        noAudio: "Kein Audio vom Gesprächsteilnehmer",
        noVideo: "Kein Video vom Gesprächsteilnehmer",
        poorAudio: "Schlechte Audioqualität vom Gesprächsteilnehmer",
        poorVideo: "Schlechte Videoqualität vom Gesprächsteilnehmer",
        callDropped: "Anruf unterbrochen"
      }
    }
  },
  ...
  countries: {
    ...
    "mo": "Macau (Sonderverwaltungszone der Volksrepublik China)",
    "cx": "Christmas Island",
    "cc": "Kokosinseln",
    "co": "Kolumbien",
    "km": "Komoren",
    ...
    "ug": "Uganda",
    "ua": "Ukraine",
    "ae": "Vereinigte Arabische Emirates",
