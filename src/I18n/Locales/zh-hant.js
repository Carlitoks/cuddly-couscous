export default (ZHTW = {
  ...
  enterNameField: "輸入名字",
  enterPayment: "輸入付款詳細資料",
  enterPaymentDetailsToContinue: "輸入付款詳細資料後繼續",
  enterPaymentDetails: "輸入或修改付款詳細資料",
  enterPaymentDetails2:
    "通話將在帳戶餘額剩下 0 分鐘時結束。輸入付款詳細資料後就能暢所欲言",
  enterPaymentDetails3:
    "您必須輸入付款詳細資料才能繼續，且將按照通話時間長短付費",
  enterPaymentDetails4:
    "輸入付款詳細資料後就能暢所欲言。否則，通話將在帳戶餘額剩下 0 分鐘時結束。",
  ...
  upTo60: "不可超過 60 分鐘",
  upTo60WithMinutes: "不可超過 {{minutes}} 分鐘",
  upTo60WithAbrev: "不可超過 60 分鐘",
  usageExamples: "使用範例",
  username: "用戶名稱",
  userProfile: "個人資料",
  ...
  newCustomerHome: {
    ...
    rateNotices: {
      ...
      noBalanceNoCardRate: "費率：每分鐘 {{rate}}。請新增卡片以利繼續通話",
      noBalanceHasCardRate: "費率：每分鐘 {{rate}}。",
      hasBalanceRate: "費率：每分鐘 {{rate}}，剩餘分鐘數：{{num}} 分鐘",
      unlimitedUntil: "{{date}} 前不限分鐘數"
    }
  },
  ...
  payments: {
    ...
    enterPaymentToTalkRate:
      "輸入付款詳細資料即可繼續通話。每分鐘 {{rate}} 就能暢所欲言。",
    addCard: "新增卡片",
    editCard: "編輯卡片",
    cardInfo: "卡片資訊",
    removeCard: "移除卡片",
  ...
  account: {
    ...
    balanceUnlimited: "不限",
    descriptions: {
      noCardNoPackage: "輸入付款詳細資料，避免通話中斷。",
      hasCardNoPackage: "購買套餐可享通話折扣。分鐘數沒有使用期限。",
      hasCardHasPackage: "剩下 {{num}} 分鐘時會自動為您的帳戶儲值",
      hasPackageUnlimitedUse: "您的套餐在 {{date}} 之前不限分鐘數",
      hasUnlimitedUse: "您在 {{date}} 之前可盡情使用，不限分鐘數",
      hasSubscription: "您的定期方案會在 {{date}} 續約"
    },
    card: {
      title: "銀行卡",
      add: "新增卡片",
      edit: "編輯",
      description: "輸入卡片即可暢所欲言，也可購買套餐，樂享超值折扣。  每分鐘標準費率：{{rate}}"
    },
    package: {
      title: "套餐",
      add: "新增套餐",
  ...
  packages: {
    ...
    browse: {
      title: "套餐",
      promo: "您有促銷代碼嗎？",
      promoPlaceholder: "請在這裡輸入代碼",
      promoApplied: "已使用代碼"
    },
    checkout: {
      title: "結帳",
      reload: "我的帳戶剩下 {{num}} 分鐘時自動為我儲值",
      needCard: "您必須新增卡片才能繼續付款。",
      summary: "訂單摘要",
      total: "總計",
      purchase: "購買套餐",
      processing: "付款處理中..."
    ...
    failure: {
      title: "付款失敗",
      description: "糟糕！我們無法處理您的付款事宜。  請檢查卡片資訊後再試一次。"
    }
  },
  ...
  minutePackage: {
    balance: "{{}} 分鐘",
    balanceUnlimited: "不限使用分鐘數",
    validBetween: "有效期限：{{date1}} - {{date2}}",
    validThrough: "到期日：{{date}}",
    special: "特殊"
  },
  ...
  correctEmailModal: {
    title: "電子郵件驗證失敗",
    description:
      "您提供的電子郵件有誤，請輸入新的電子郵件地址。",
    label: "新的電子郵件地址",
    titleSuccess: "成功",
    descriptionSuccess:
      '電子郵件更新完畢！您可以使用新的電子郵件「{{email}}」登入翻譯精靈',
    descriptionTaken:
      '「{email}」這個電子郵件已經註冊過了。  您可以使用該電子郵件地址登入，也可以指定新的電子郵件地址。'
  },
  ...
  newCustomerOnboarding: {
    ...
    intro: {
      title: "即時協助",
      description:
        "只要按一下按鈕，全天 24 小時隨時有真人譯者提供語言協助。  費率：每分鐘 1 美元。",
      descriptionRate:
