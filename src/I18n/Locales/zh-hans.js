export default (ZHCN = {
  acceptAllPermissionsCustomer: "您必须在设置中开启麦克风和相机的访问权限才能使用翻译精灵拨打电话。",
  acceptAllPermissionsLinguist: "您必须在设置中开启麦克风和相机的访问权限才能接听来电",
  ...
  firstname: "名字",
  gender: "性别",
  genderAlert: "语言专家可以选择匹配特定性别的客户。如果您不想公开自己的性别，则不会匹配到有性别偏好的语言专家。",
  ...
  operatingHoursAlertMessage: "中文：\n- 东部时间 (EDT) 上午 10 点 - 晚上 7 点\n\n日语：\n- 东部时间 (EDT) 晚上 7 点 - 上午 7 点\n-日本标准时间上午 8 点 - 晚上 8 点",
  other: "其他",
  ...
  session: {
    ...
    rating: {
      ...
      about: {
        label: "通话详情",
        placeholder: "请用两句话描述通话内容。例如：这次通话目的是购买火车票。客户想从东京出发前往大阪，需要关于售票机使用的帮助。"
      },
      classification: "通话类型",
      classifications: {
        trial: "语言专家试通话",
      ...
      technical: {
        label: "技术问题（可选）",
        placeholder: "请详细描述通话过程中出现的相关技术问题。"
      },
      technicalFlags: {
        noAudio: "听不见对方的声音",
        noVideo: "看不见对方的画面",
