export default (ZHCN = {
  ...
  complimentMinutes: "{{organizer}} 慷慨赠送 {{maxMinutesPerUser}} 分钟",
  minutesAdded: "分钟数已增加",
  invalidCode: "代码无效",
  ...
  enterPayment: "输入付款详情",
  enterPaymentDetailsToContinue: "输入付款详情以继续",
  enterPaymentDetails: "输入或修改付款详情",
  enterPaymentDetails2:
    "帐户余额为 0 分钟时您的通话将自动结束。输入付款详情后便可畅聊无阻",
  enterPaymentDetails3:
    "您必须输入付款详情后才能继续，并将根据您的通话时长进行收费",
  enterPaymentDetails4:
    "输入付款详情后便可畅聊无阻。否则，帐户余额为 0 分钟时您的通话将自动结束。",
  enterPaymentOnboarding:
    "输入付款详情后便可畅聊无阻。帐户余额为 0 分钟时，您需要支付额外使用的时间。",
  ...
  upTo60: "不超过 60 分钟",
  upTo60WithMinutes: "不超过 {{minutes}} 分钟",
  upTo60WithAbrev: "不超过 60 分钟",
  usageExamples: "使用示例",
  username: "用户名",
  userProfile: "个人资料",
  ...
  payments: {
    ...
    cvv: {
      ...
      errInvalid: "无效的 CVV",
      description:
        '在您 VISA 卡、万事达卡或发现卡等信用卡或借记卡上的 CVV（“银行卡安全码”）是由 3 位数字组成的代码。  在美国运通卡上则是 4 位数字。'
    }
  },
  ...
  api: {
    ...
    errTemporaryTryAgain: "发生暂时性错误。请过几分钟再试。",
    errLogin: "登录出错",
  ...
  customerOnboarding: {
    ...
    intro: {
      title: "无忧旅行",
      description:
        "轻轻一点，24 小时全天候真人译员实时在线按需提供语言帮助及文化建议。",
      button: "继续"
    },
    allSet: "设置完成！",
    location: {
