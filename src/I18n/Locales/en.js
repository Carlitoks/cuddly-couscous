export default (ENG = {
  ...
  home: "Home",
  whereAreYouNow: "Select your location:",
  hotel: "Hotel",
  ...
  linguistReconnecting: "{{firstName}} {{lastInitial}} is reconnecting...",
  ...
  upTo60WithMinutes: "Up to {{minutes}} min",
  upTo60WithAbrev: "Up to 60 min",
