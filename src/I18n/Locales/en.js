export default (ENG = {
  acceptAllPermissionsCustomer: "You must enable microphone and camera permissions in your settings in order to make a call with Jeenie.",
  acceptAllPermissionsLinguist: "You must accept microphone and camera permissions in your settings before you can accept an incoming call.",
  ...
  gender: "Gender",
  genderAlert: "Linguists have the option to be matched with a customer of a specific gender. If you prefer not to disclose your gender, you will not be matched with linguists with a preference.",
  ...
  ok: "Ok",
  online: "Online",
  operatingHoursAlertTitle: "Please note our operating hours",
  operatingHoursAlertMessage: "Chinese:\n- 10am - 7pm Eastern Time (EDT)\n\nJapanese:\n- 7pm - 7am Eastern Time (EDT)\n- 8am - 8pm Japan Standard Time (JST)",
  other: "Other",
  ...
  api: {
    ...
    errEventInvalid: "This code is invalid.",
