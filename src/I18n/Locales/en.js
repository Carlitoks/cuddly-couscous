export default (ENG = {
  ...
  isReconnecting: "{{firstName}} {{lastInitial}}. is reconnecting...",
  ...
  lauchScreenSwipe5:
    "In celebration of our launch, your first 27 minutes are FREE …compliment of Jeenie!",
  lastname: "Last name",
