export default (KO = {
  acceptAllPermissionsCustomer: "Jeenie와 통화하려면 설정에서 마이크 및 카메라 사용 권한을 활성화해야 합니다.",
  acceptAllPermissionsLinguist: "수신 통화를 수락하려면 먼저 설정에서 마이크 및 카메라 사용 권한을 허용해야 합니다.",
  ...
  firstname: "이름",
  gender: "성별",
  genderAlert: "링귀스트에게는 특정 성별의 고객과 연결하는 옵션이 제공됩니다. 성별을 공개하지 않으면 선호하는 링귀스트와 연결되지 않습니다.",
  ...
  session: {
    ...
    rating: {
      ...
      about: {
        label: "통화 상세정보",
        placeholder: "통화 내용을 2문장으로 기입해 주세요. 예: 열차 티켓 구매에 대한 통화였습니다. 고객이 도쿄에서 오사카로 가고 싶다고 했고 티켓 판매기 사용과 관련하여 도움을 요청했습니다."
      },
      classification: "통화 유형",
      classifications: {
        trial: "링귀스트 체험 통화",
        demo: "제품 데모 통화",
        help: "언어 및 문화 지원"
      ...
      technical: {
        label: "기술적 문제(선택 사항)",
        placeholder: "해당되는 경우, 통화 중에 발생한 기술적 문제에 대해 자세히 설명해 주세요."
      },
      technicalFlags: {
        noAudio: "상대방 오디오 없음",
        noVideo: "상대방 영상 없음",
        poorAudio: "상대방 오디오 품질 문제",
        poorVideo: "상대방 영상 품질 문제",
        callDropped: "통화 중 끊어짐"
      }
    }
  },
